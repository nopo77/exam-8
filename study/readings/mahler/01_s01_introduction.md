...
topics: [credibility_theory, experience_rating, shifting_parameters, baseball_analogy]
key_formulas: []
---

> **TL;DR**
> - Paper uses baseball won-lost records (1901–1960) as a controlled analogy for insurance experience rating.
> - Primary focus: how shifting risk parameters over time should reduce credibility given to older data.
> - Structure proceeds from simple to more general solutions; mathematical derivations confined to appendices.
> - Three criteria for comparing solutions are developed and applied to both NL and AL data sets.
