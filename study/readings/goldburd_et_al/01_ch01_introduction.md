...
topics: [introduction_to_glms, classification_ratemaking, multiplicative_rating_structure]
key_formulas: []
---
> **TL;DR**
> - GLMs are now near-ubiquitous in personal lines insurance pricing for classification ratemaking
> - Monograph goal: give practicing P&C actuaries all tools to build a market-ready classification plan from raw data
> - Target audience: credentialed actuaries familiar with basic ratemaking (Werner & Modlin) and earlier CAS exam material
> - Log link GLMs produce multiplicative rating structures — the standard for insurance pricing
